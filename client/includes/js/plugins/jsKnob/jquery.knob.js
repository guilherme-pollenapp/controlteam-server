        ...
        this._carve = function () {
            if (this.relative) {
                var w = this.relativeWidth ?
                    ...
                    this.$div.parent().width(), h = this.relativeHeight ?
    ...
    k.Dial = function () {
        ...
        this.listen = function () {
            ...
            var s = this, mwTimerStop, mwTimerRelease, mw = function (e) {
                e.preventDefault();
                var ori = e.originalEvent, deltaX = ori.detail || ori.wheelDeltaX, deltaY = ori.detail || ori.wheelDeltaY, v = s._validate(s.o.parse(s.$.val()))
